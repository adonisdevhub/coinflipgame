            ...
            <div className="header">
                ...
                <div className="nav" style={{opacity: 1}}>
                    ...
                    <ul id="menu-flip-menu-1" className="metaportal_fn_main_nav">
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-709"><NavLink to="/"><span className="creative_link">Home</span></NavLink></li>
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-710"><NavLink to="/stats"><span className="creative_link">Stats</span></NavLink></li>
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-711"><NavLink to="/history"><span className="creative_link">FLIP History</span></NavLink></li>
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-708"><NavLink to="/faqs"><span className="creative_link">FAQs</span></NavLink></li>
                        <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-712"><NavLink to="/profile"><span className="creative_link">Profile</span></NavLink></li>
